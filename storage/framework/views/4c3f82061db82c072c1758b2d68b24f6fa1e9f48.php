            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                          <span class="m-nav__link-text"><?php echo app('translator')->getFromJson('pages.edit_administrator'); ?></span>
                        </li>
                        ...
                        <div class="m-portlet__head">
                            <div class="m-portlet__head-caption">
								...
								<i class="la la-gear"></i>
                                    ...
                                    <h3 class="m-portlet__head-text"><?php echo app('translator')->getFromJson('pages.edit_administrator'); ?></h3>
                                </div>
                            </div>
                        </div>

                        <form class="m-form validation-form" method="post" action="<?php echo e(route('admin.administrators.update',[ 'id' => $administrator->id ])); ?>">
                            ...
                            <div class="m-portlet__body">
                                ...
                                <div class="m-form__section m-form__section--first">
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-10">
                                            <select name="role" class="form-control m-bootstrap-select m-bootstrap-select--solid m_form_type" required>
                                                <?php $__currentLoopData = \App\Role::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php echo e($administrator->role_id == $role->id ? 'selected' : ''); ?> value="<?php echo e($role->id); ?>"><?php echo e($role->name); ?></option>
                                ...
                                <div class="m-form__section m-form__section--first">
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-10">
                                            <input type="text" id="name" class="form-control m-input" name="name" value="<?php echo e($administrator->name); ?>" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="m-form__section m-form__section--first">
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-10">
                                            <input type="email" id="email" class="form-control m-input" name="email" value="<?php echo e($administrator->email); ?>" required>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.admin',[ 'page'=> 'edit_administrator' ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>