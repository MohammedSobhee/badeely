    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-subheader ">
            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title m-subheader__title--separator"><?php echo app('translator')->getFromJson('pages.categories_visits'); ?></h3>
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <span class="m-nav__link-text"><?php echo app('translator')->getFromJson('pages.categories_visits'); ?></span>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="m-portlet__head-caption">
                        ...
                        <div class="row align-items-center">
                            ...
                            <span class="m-portlet__head-icon">
                                ...
                                <h3 class="m-portlet__head-text"><?php echo app('translator')->getFromJson('pages.categories_visits'); ?></h3>
                    ...
                    <div class="collapse show" id="collapseExample">
                        ...
                        <form class="form-group m-form__group row align-items-center">
                                    ...
                                    <div class="m-form__control">
                                        <div class="">
                                            <input type="text" class="form-control" id="from" readonly="" name="from"
                                                   ...
                                                   placeholder="<?php echo app('translator')->getFromJson('inputs.from_date'); ?>">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="m-form__control">
                                        <div class="">
                                            <input type="text" class="form-control" id="to" readonly="" name="to"
                                                   value="<?php echo e(request('to')); ?>" placeholder="<?php echo app('translator')->getFromJson('inputs.to_date'); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="d-md-none m--margin-bottom-10"></div>
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="<?php echo e(route('admin.reports.categories_visits')); ?>"
                    ...
                    <table class="table table-hover table-responsive sortable" width="100%">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($category->follow_num); ?></td>
                                <td><?php echo e($category->countries); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin',[ 'page'=> 'categories_visits' ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>