...
<script type="text/javascript">
    ...
    $(document).on('change', '#country_id', function () {
        ...
        if (selection == '') {
            $('#followers_collection').html('<option value=""><?php echo app('translator')->getFromJson('inputs.all'); ?></option>').trigger("change");
        ...
        $.ajax({
            url: '<?php echo e(url('admin/categories/')); ?>/' + selection,
            type: 'GET',
    ...
    $(document).on('change', '#followers_collection', function () {
        ...
        if ($('#action').val() == 'account')
            $.ajax({
                url: '<?php echo e(url('admin/items/')); ?>/' + _country_id + '/account' + '/' + selection,
                type: 'GET',
    ...
    $(document).on('change', '#action', function () {
        ...
        $.ajax({
            url: '<?php echo e(url('admin/items/')); ?>/' + _country_id + '/' + $(this).val() + '/' + $('#followers_collection').val(),
            type: 'GET',
