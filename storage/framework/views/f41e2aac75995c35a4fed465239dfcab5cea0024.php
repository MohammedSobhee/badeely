                                    ...
                                    <div class="m-form__control">
                                        <div class="">
                                            <select id="target" name="target" class="form-control m-bootstrap-select m-bootstrap-select--solid m_form_type">
                                                <option value=""><?php echo app('translator')->getFromJson('inputs.all'); ?> (<?php echo e(\App\TopLevelView::count()); ?>)</option>
                                                ...
                                                <option value="top" <?php echo e(request('target') == 'top' ? 'selected' : ''); ?>>Top (<?php echo e(\App\TopLevelView::where('target', 'top')->count()); ?>)</option>
