            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="m-portlet">
                        ...
                        <form class="m-form validation-form" method="post" action="<?php echo e(route('admin.categories.update',[ 'id' => $category->id ])); ?>" enctype="multipart/form-data">
                            ...
                            <div class="m-portlet__body">
                                                        ...
                                                        <div class="tab-pane <?php echo e($loop->first ? 'active':''); ?>" id="tb-lang-<?php echo e($code); ?>">
                                                            ...
                                                            <div class="m-form__section m-form__section--first">
                                                                <div class="form-group m-form__group row">
                                                                    <label class="col-2 col-form-label" for="category_labels[<?php echo e($code); ?>]"><?php echo app('translator')->getFromJson('inputs.name'); ?> :</label>
                                                                    <div class="col-10">
                                                                        <input type="text" id="category_labels[<?php echo e($code); ?>]" class="form-control m-input" name="category_labels[<?php echo e($code); ?>]" value="<?php echo e($category->name($code)); ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                ...
                                <div class="m-form__section m-form__section--first">
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-10">
                                            <img id="upload-pic" src="<?php echo e($category->image()); ?>" class="img-responsive" width="500">
