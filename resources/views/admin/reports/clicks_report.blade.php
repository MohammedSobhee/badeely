@extends('layouts.admin',[ 'page'=> 'clicks_report' ])
@section('content')
    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-subheader ">
            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title m-subheader__title--separator">@lang('pages.clicks_report')</h3>
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <span class="m-nav__link-text">@lang('pages.clicks_report')</span>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="m-portlet__head-caption">
                        ...
                        <div class="row align-items-center">
                            ...
                            <span class="m-portlet__head-icon">
                                ...
                                <h3 class="m-portlet__head-text">@lang('pages.clicks_report')</h3>
                    ...
                    <div class="collapse show" id="collapseExample">
                        ...
                        <form class="form-group m-form__group row align-items-center">
                                    ...
                                    <div class="m-form__control">
                                        <div class="">
                                            <select id="filters" name="filters" class="form-control m-bootstrap-select m-bootstrap-select--solid m_form_type">
                                                ...
                                                <option value="rate" {{ request('filters') == 'rate' ? 'selected' : '' }}>Top</option>
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="{{ route('admin.reports.clicks_report') }}" class="btn btn-info m-btn--wide">@lang('dashboard.show_all')</a>
                            </div>
