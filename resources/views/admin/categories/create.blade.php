@extends('layouts.admin',[ 'page'=> 'create_category' ])
@section('content')
            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <span class="m-nav__link-text">@lang('pages.create_category')</span>
                        </li>
                        ...
                        <div class="m-portlet__head">
                            <div class="m-portlet__head-caption">
								...
								<i class="la la-gear"></i>
                                    ...
                                    <h3 class="m-portlet__head-text">@lang('pages.create_category')</h3>
                                </div>
                            </div>
                        </div>

                        <form class="m-form validation-form" method="post" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                            ...
                                            <div class="tab-pane {{ $loop->first ? 'active':''}}" id="tb-lang-{{ $code }}">
                                                ...
                                                <div class="m-form__section m-form__section--first">
                                                    <div class="form-group m-form__group row">
                                                        <label class="col-2 col-form-label" for="category_labels[{{ $code }}]">@lang('inputs.title') :</label>
                                                        <div class="col-10">
                                                            <input type="text" id="category_labels[{{ $code }}]" class="form-control m-input" name="category_labels[{{ $code }}]" value="{{ old('category_labels.'.$code) }}">
                                                        </div>
                                                    </div>
                                                </div>
