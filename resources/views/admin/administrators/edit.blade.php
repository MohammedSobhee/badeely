@extends('layouts.admin',[ 'page'=> 'edit_administrator' ])
@section('content')
            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                          <span class="m-nav__link-text">@lang('pages.edit_administrator')</span>
                        </li>
                        ...
                        <div class="m-portlet__head">
                            <div class="m-portlet__head-caption">
								...
								<i class="la la-gear"></i>
                                    ...
                                    <h3 class="m-portlet__head-text">@lang('pages.edit_administrator')</h3>
                                </div>
                            </div>
                        </div>

                        <form class="m-form validation-form" method="post" action="{{ route('admin.administrators.update',[ 'id' => $administrator->id ]) }}">
                            {{ csrf_field() }}
                            {{ method_field('PATCH') }}
                            ...
                            <div class="m-portlet__body">
                                ...
                                <div class="m-form__section m-form__section--first">
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-10">
                                            <input type="text" id="name" class="form-control m-input" name="name" value="{{ $administrator->name }}" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="m-form__section m-form__section--first">
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-10">
                                            <input type="email" id="email" class="form-control m-input" name="email" value="{{ $administrator->email }}" required>
                                        </div>
                                    </div>
                                </div>
