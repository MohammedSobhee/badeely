@extends('layouts.admin',[ 'page'=> 'create_role' ])
@section('content')
            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <span class="m-nav__link-text">@lang('pages.create_role')</span>
                        </li>
                        ...
                        <div class="m-portlet__head">
                            <div class="m-portlet__head-caption">
								...
								<i class="la la-gear"></i>
                                    ...
                                    <h3 class="m-portlet__head-text">@lang('pages.create_role')</h3>
                                </div>
                            </div>
                        </div>

                        <form class="m-form validation-form" method="post" action="{{ route('admin.roles.store') }}">
                            {{ csrf_field() }}
                                                    ...
                                                    <div class="prem-edit m-form__group m-radio-inline">
                                                        <label class="m-checkbox remmber-rg">
                                                            <input class="" id="name" name="permissions[]"
                                                                   ...
                                                                   type="checkbox" value="admin.{{ $group }}.{{ $p }}">
                                                            <span></span>
                                                            @lang('permissions.'.$p)
                                                        </label>
                                                    </div>
