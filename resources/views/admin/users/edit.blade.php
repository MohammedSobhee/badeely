@extends('layouts.admin',[ 'page'=> 'edit_user' ])
@section('content')
            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <span class="m-nav__link-text">@lang('pages.edit_user')</span>
                        </li>
                        ...
                        <div class="m-portlet__head">
                            <div class="m-portlet__head-caption">
								...
								<i class="la la-gear"></i>
                                    ...
                                    <h3 class="m-portlet__head-text">@lang('pages.edit_user')</h3>
                                </div>
                            </div>
                        </div>

                        <form class="m-form validation-form" method="post" action="{{ route('admin.users.update',[ 'id' => $user->id ]) }}">
                            {{ csrf_field() }}
                            {{ method_field('PATCH') }}
                            <div class="m-portlet__body">
                                ...
                                <div class="m-form__section m-form__section--first">
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-10">
                                            <input type="text" id="name" class="form-control m-input" name="name" value="{{ $user->name }}" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="m-form__section m-form__section--first">
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-10">
                                            <input type="text" id="email" class="form-control m-input" name="email" value="{{ $user->email }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="m-form__section m-form__section--first">
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-10">
                                            <input type="text" id="mobile" class="form-control m-input" name="mobile" value="{{ $user->mobile }}">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-10">
                                            <select id="language" name="language" class="form-control m-bootstrap-select m-bootstrap-select--solid m_form_type">
                                                ...
                                                @foreach(config('languages') as $key => $label)
                                                    <option value="{{ $key }}" {{ $user->language ==  $key ? 'selected' : ''}}>{{ $label }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-10">
                                            <select id="gender" class="form-control m-bootstrap-select m-bootstrap-select--solid m_form_type" name="gender">
                                                ...
                                                <option value="male" {{ $user->gender == 'male' ? 'selected' : '' }}>@lang('inputs.male')</option>
                                                <option value="female" {{ $user->gender == 'female' ? 'selected' : '' }}>@lang('inputs.female')</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-10">
                                            <select id="age" class="form-control m-bootstrap-select m-bootstrap-select--solid m_form_type" name="age">
                                                ...
                                                <option value="16-24" {{ $user->age == '16-24' ? 'selected' : '' }}>16-24</option>
                                                <option value="25-29" {{ $user->age == '25-29' ? 'selected' : '' }}>25-29</option>
                                                <option value="30-40" {{ $user->age == '30-40' ? 'selected' : '' }}>30-40</option>
                                                <option value="+40" {{ $user->age == '+40' ? 'selected' : '' }}>+40</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="m-form__section m-form__section--first">
                                    <div class="form-group m-form__group row">
										...
										<span class="m-switch m-switch--lg m-switch--info m-switch--icon">
												<label>
						                        <input type="checkbox" {{ $user->is_confirmed == 1 ? 'checked="checked"' : '' }} name="is_confirmed" value="1">
						                        <span></span>
						                        </label>
						                    </span>
                                        </div>
